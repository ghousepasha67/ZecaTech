...
function StickyNavbar() {
  ...
  return (
    <div>
      <nav class="fixedElement bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <header class="py-4 sm:px-4 sm:px-10 relative z-50">
          <div class='max-w-7xl w-full mx-auto flex flex-wrap items-center gap-4 p-2'>
            ...
            <div id="collapseMenu" className={"max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-40 ml-12 max-lg:before:inset-0 max-lg:before:z-50 " + (expand ? '' : 'max-lg:hidden lg:!block')}>
              ...
              <ul class='lg:flex lg:ml-12 lg:gap-x-6 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
                ...
                <NavLink to='/'><a 
                    class='hover:text-[#0191BD] text-gray-600  f-s-19 font-bold lg:hover:fill-[#0191BD] block'>Home</a> </NavLink></li>
                <li class='group gap-7 m-r-2 max-lg:border-b max-lg:py-3 relative'>
                <NavLink to='/secondPage'><a 
                    class='hover:text-[#0191BD] text-gray-600 f-s-19 font-bold lg:hover:fill-[#0191BD] block'>About Us</a></NavLink></li>
                <li class='group gap-7 m-r-2 max-lg:border-b max-lg:py-3 relative'>
                <NavLink to='/thirdPage'><a 
                    class='hover:text-[#0191BD] text-gray-600 f-s-19 font-bold lg:hover:fill-[#0191BD] block'>Services <ArrowDown /></a></NavLink>
                ...
                <li class='group gap-7 m-r-2 max-lg:border-b max-lg:py-3 relative'>
                  <NavLink to='/Fourpage'><a class='hover:text-[#0191BD] text-gray-600 f-s-19 font-bold lg:hover:fill-[#0191BD] block'>Careers</a></NavLink>
                </li>
              </ul>
            </div>
