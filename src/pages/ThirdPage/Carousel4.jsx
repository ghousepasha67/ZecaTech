  ...
  return (
    <div class="mt-6 relative font-[sans-serif] shadow-lg hover:shadow-2xl  object-cover before:absolute w-full before:h-full      page_header_default::before">
      ...
      <div class="min-h-[380px] relative page_header_default flex flex-col justify-center items-center text-center p-6">
        ...
        <h2 class="text-white sm:text-4xl about-text text-2xl font-bold mb-6">Testing and QA Services</h2>
        <nav class="flex breadcrumb" aria-label="Breadcrumb">
          <ol class="flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li class="inline-flex items-center">
              <a href="home" class="inline-flex items-center text-sm font-medium text-white-700   dark:text-white-400 dark:hover:text-white">Home</a>
            </li>
            <li className='inline-flex items-center'>
              <div class="flex items-center">
                ...
                <a href="#" class="ms-1 text-sm font-medium text-white-700   md:ms-2 dark:text-white-400 dark:hover:text-whitex">Srevice</a>
              </div>
            </li>
            <li className='inline-flex items-center'>
              <div class="flex items-center">
                ...
                <a href="#" class="ms-1 text-sm font-medium text-white-700   md:ms-2 dark:text-white-400 dark:hover:text-whitex">Testing and QA Services</a>
              </div>
            </li>
