              ...
              <ul class='lg:flex lg:ml-12 lg:gap-x-6 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
                <li class='group gap-7 m-r-2 m-l-3 max-lg:border-b max-lg:py-3 relative'>
                  <a href='javascript:void(0)'
                    class='hover:text-[#62360F] text-gray-600 text-[15px] font-bold lg:hover:fill-[#62360F] block'>Home</a> </li>
                <li class='group gap-7 m-r-2 max-lg:border-b max-lg:py-3 relative'>
                  <a href='javascript:void(0)'
                    class='hover:text-[#62360F] text-gray-600 text-[15px] font-bold lg:hover:fill-[#62360F] block'>AboutUs</a></li>
                <li class='group gap-7 m-r-2 max-lg:border-b max-lg:py-3 relative'>
                  <a href='javascript:void(0)'
                    class='hover:text-[#62360F] text-gray-600 text-[15px] font-bold lg:hover:fill-[#62360F] block'>Services <ArrowDown /></a>
                ...
                <li class='group gap-7 m-r-2 max-lg:border-b max-lg:py-3 relative'>
                  <a href='javascript:void(0)' class='hover:text-[#62360F] text-gray-600 text-[15px] font-bold lg:hover:fill-[#62360F] block'>Careers</a>
                </li>
              </ul>
            </div>
