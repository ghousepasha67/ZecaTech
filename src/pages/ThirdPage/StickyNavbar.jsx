  ...
  return (
    <div>
      <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <header class="py-4 sm:px-4 sm:px-10 relative z-50">
          <div class='max-w-7xl w-full mx-auto flex flex-wrap items-center gap-4 p-2'>
            ...
            <div id="collapseMenu"
              className={"max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-40 ml-12 max-lg:before:inset-0 max-lg:before:z-50 " + (expand ? '' : 'max-lg:hidden lg:!block')}>
              ...
              <ul class='lg:flex lg:ml-12 lg:gap-x-6 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
                <li class='group gap-7 m-r-2 m-l-3 max-lg:border-b max-lg:py-3 relative'>
                  <a href='javascript:void(0)'
                    class='hover:text-[#0191BD] text-gray-600 text-[19px] font-bold lg:hover:fill-[#0191BD] block'>Home</a> </li>
                <li class='group gap-7 m-r-2 max-lg:border-b max-lg:py-3 relative'>
                  <a href='javascript:void(0)'
                    class='hover:text-[#0191BD] text-gray-600 text-[19px] font-bold lg:hover:fill-[#0191BD] block'>About Us</a></li>
                <li class='group gap-7 m-r-2 max-lg:border-b max-lg:py-3 relative'>
                  <a href='javascript:void(0)'
                    class='hover:text-[#0191BD] text-gray-600 text-[19px] font-bold lg:hover:fill-[#0191BD] block'>Services <ArrowDown /></a>
                  <ul class='absolute shadow-lg bg-white space-y-3 lg:top-5 max-lg:top-8 -left-14 min-w-[905px] z-50 max-h-0 overflow-hidden group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500'>
      ...
      <CustomButton className='Custombtn theme-btn-one btn-bg-theme ' name='UX/UI Design' ></CustomButton>
                ...
                <li class='group gap-7 m-r-2 max-lg:border-b max-lg:py-3 relative'>
                  <a href='javascript:void(0)' class='hover:text-[#0191BD] text-gray-600 text-[19px] font-bold lg:hover:fill-[#0191BD] block'>Careers</a>
                </li>
              </ul>
            </div>
            <div class='flex ml-auto'>
              ...
              <button class='text-white  bg-[#0191BD] border border-full-3 flex items-center transition-all font-bold px-5 sm:py-3'>Get In Touch</button>
...
<dialog id="my_modal_3" className="modal max-w-4xl">
  <div className="modal-box">
    ...
    <div className='flex '>
                  <div className='flex lg:w-3/5  px-4'>
                    <form className=' p-8 shadow rounded mx-auto w-full max-w-lg'>
                       <h1 className='text-left'>Your Name</h1>
                      <input name='name' type='text' placeholder='Enter Your Name' className='input border-2 border-gray-300 w-full p-2 rounded' />
                      <h1 className='text-left'>Your email</h1>
                      <input name='companyName' type='text' placeholder='Enter Your email' className='input border-2 border-gray-300 w-full p-2 rounded' />
                      <h1 className='text-left'>Phone Number</h1>
                      <input name='email' type='email' placeholder='Enter Your number' className='input border-2 border-gray-300 w-full p-2 rounded' />
                      <h1 className='text-left'>Subject</h1>
                      <input name='phoneNumber' type='tel' placeholder='Enter Your Subject' className='input border-2 border-gray-300 w-full p-2 rounded' />
                      <h1 className='text-left'>Your message(optional)</h1>
                      <textarea name='message' placeholder='Enter Your message' className='input border-2 border-gray-300 w-full p-2 rounded' rows='4'  ></textarea>
                      <CustomButton className='Custombtn theme-btn-one btn-bg-theme' name='Submit'></CustomButton>
                      </form>
                  </div>
                  <div className='w-full bg-gray-50 max-w-4xl px-4'>
